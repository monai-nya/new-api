...
type TaskPrivateData struct {
	...
	FundingChargedQuota *int                `json:"funding_charged_quota,omitempty"` // 资金来源实际成功扣减额度；nil 表示旧任务
	TokenChargedQuota   *int                `json:"token_charged_quota,omitempty"`   // Token 实际成功扣减额度；nil 表示旧任务
